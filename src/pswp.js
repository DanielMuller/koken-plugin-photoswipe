var initPhotoSwipeFromDOM = function() {
	...
	var openPhotoSwipe = function(index, disableAnimation) {
		...
		gallery.listen('beforeResize', function() {
			...
			if(useImageSize!='huge' && realViewportWidth >=2048) {
				useImageSize = 'huge';
				imageSrcWillChange = true;
			} else if(useImageSize!='xlarge' && realViewportWidth >= 1600 && realViewportWidth<2048) {
				useImageSize = 'xlarge';
				imageSrcWillChange = true;
			} else if(useImageSize!='large' && realViewportWidth >= 1024 && realViewportWidth<1600) {
				useImageSize = 'large';
				imageSrcWillChange = true;
			} else if(useImageSize!='medium_large' && realViewportWidth<1024) {
				useImageSize = 'medium_large';
				imageSrcWillChange = true;
			}
